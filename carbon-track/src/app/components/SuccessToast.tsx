...
export default function SuccessToast({ message, onClose }: { message: string, onClose: () => void }) {
  ...
  return (
    <div className="fixed left-1/2 top-6 z-50 flex items-center justify-center w-full pointer-events-none" style={{ transform: "translateX(-50%)" }}>
      <div className="pointer-events-auto bg-white rounded-lg shadow-lg px-6 py-4 flex items-center gap-3 min-w-[320px] max-w-md border-2 border-[#214A5A] relative">
